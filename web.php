...
Route::post('/book/save-review', [HomeController::class, 'saveReview'])->middleware('auth')->name('book.saveReview');
...
Route::post('/account/delete-profile', [AccountController::class, 'deleteProfile'])->name('account.deleteProfile');
